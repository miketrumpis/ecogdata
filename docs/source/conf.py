...
import os
import sys
_path_to_ecogdata = os.path.abspath('../../src/')
...
# Make links to notebook files in the epilog (this "path" hack only works with pathsep=='/')
nbsphinx_epilog = """
----

Generated by nbsphinx_ from a Jupyter_ notebook: :download:`{{env.docname.split('/')[-1] + '.ipynb'}}`
