...
from ecogdata.parallel.array_split import split_at, split_optional_output, split_output
...
bfilter = split_optional_output('out', runs_inplace=True, same_shape=True, split_arg=(2,))(bfilter_serial)
...
lfilter = split_output(split_arg=(2,), split_kwarg='zi', splice_at=(0,))(lfilter_serial)
